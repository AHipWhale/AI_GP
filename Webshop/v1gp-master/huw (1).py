...
class HUWebshop(object):
    ...
    recommendationtypes = {0:"Anderen kochten ook",1:"Soortgelijke producten",2:'Combineert goed met', 3:'Passend bij uw gedrag',4:'Persoonlijk aanbevolen', 5:'In de aanbieding'}
    ...
    def homepages(self):
        rec_type = list(self.recommendationtypes.keys())[5]
        rec_type2 = list(self.recommendationtypes.keys())[4]
        return self.renderpackettemplate('homepage.html',{ \
            'r_products': self.recommendations(8, rec_type), \
            'r_type': rec_type, \
            'r_string': list(self.recommendationtypes.values())[5],\
            'r_products2': self.recommendations(4, rec_type2), \
            'r_type2':  rec_type2, \
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        rec_type = list(self.recommendationtypes.keys())[0]
    ...
    def productdetail(self, productid):
        ...
        return self.renderpackettemplate('productdetail.html', {'product':product,\
            ...
            'r_products':self.recommendations(4, rec_type, product), \
            'r_type':rec_type,\
    ...
    def shoppingcart(self):
        ...
        if i[0] is True:
            return self.renderpackettemplate('shoppingcart.html', {'itemsincart':i,\
                'r_products':self.recommendations(4, rec_type, i[-1]), \
                'r_type':rec_type,\
