...
class HUWebshop(object):
    ...
    recommendationtypes = {0:"Veel gekochte producten",1:"Andere optie",2:'Combineert goed met', 3:'Passend bij jou',4:'Speciaal voor jou', 5:'In de aanbieding'}
    ...
    def __init__(self, app):
        ...
        self.app.add_url_rule('/', 'index', self.homepages)
    ...
    def renderpackettemplate(self, template="homepage.html", packet={}):
        ...
        packet sent to the templating engine, then class upon Flask to forward
    ...
    def recommendations(self, count, type, product_id=0000,):
        ...
        resp = requests.get(self.recseraddress+"/"+session['profile_id']+"/"+str(count)+"/"+str(type)+"/"+str(product_id))
    ...
    def homepages(self):
        rec_type = list(self.recommendationtypes.keys())[4]
        rec_type2 = list(self.recommendationtypes.keys())[5]
        return self.renderpackettemplate('homepage.html',{ \
            'r_products2': self.recommendations(8, rec_type2), \
            'r_type2':  rec_type2, \
            'r_string2': list(self.recommendationtypes.values())[5],\
            'r_products': self.recommendations(4, rec_type), \
            'r_type': rec_type, \
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        rec_type = list(self.recommendationtypes.keys())[1]
    ...
    def productdetail(self, productid):
        ...
        id provided. """
        rec_type = list(self.recommendationtypes.keys())[3]
        ...
        return self.renderpackettemplate('productdetail.html', {'product':product,\
            ...
            'r_products':self.recommendations(4, rec_type, productid), \
            'r_type':rec_type,\
    ...
    def shoppingcart(self):
        ...
        i = []
        rec_type = list(self.recommendationtypes.keys())[2]
        ...
        if i == []:
            ...
            return self.renderpackettemplate('shoppingcart.html', {'itemsincart':i,\
                'r_products':self.recommendations(4, rec_type,i[-1]["id"]), \
                'r_type':rec_type,\
